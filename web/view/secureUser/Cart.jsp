...
<div class=" h-fit bg-gray-200 w-full rounded-md py-10 p-2">
    ...
    <div class="m-8 p-8 bg-white shadow-md rounded-md dark:bg-gray-800">
        ...
        <div class="grid grid-cols-5 gap-y-12 p-8">
            ...
            <% double sum = 0.00, shipping = 25.00, free = 0.00, freeShipping = 0.0; %>
            ...
            <div class="col-span-1">
                <!--INNER FORM - CHANGE ITEM QUANTITY FORM STARTS HERE-->
            ...
            <!--subtotal price-->
            <div class="col-span-1 py-4 ml-10"> 
        ...
        <!--order summary-->
        <div class=" w-full bg-gray-100 dark:bg-gray-900 h-full p-12">
            <div>
                ...
                <div class="flex items-center justify-between pt-5">
                    ...
                    <p class="text-base leading-none text-gray-800 dark:text-white"><% if (sum >= 200.00) {
