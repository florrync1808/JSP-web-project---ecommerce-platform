 <% String orderId = session.getAttribute("CuOrderId").toString(); %>
 <% String createdAt = session.getAttribute("CuDateTime").toString(); %>
...
<div class="flex items-center justify-center h-screen">
    <div>
        <div class="flex flex-col items-center space-y-2">
            ...
            <a href="/pepegacoJAVAEE6/DisplayPurchaseHistory"
