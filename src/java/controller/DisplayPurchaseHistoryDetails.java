...
import model.ProductOfOrderList;

/**
 *
 * @author Vallerie
 */
public class DisplayPurchaseHistoryDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            System.out.println(orderId);
            System.out.println(createdAt + "helow");
            System.out.println(amt);
            
            session.setAttribute("customerOrderId", orderId);
            session.setAttribute("purchaseHistoryDetails", poList);
            session.setAttribute("DateTime", createdAt);
            session.setAttribute("amount", amt);
            response.sendRedirect("/pepegacoJAVAEE6/view/secureUser/PurchaseHistoryDetails.jsp");
